...
* 🔍 **Course Search**: Search Coursera courses by course name or offering university
* ⚡ **Debounced Search**: Optimized search with debouncing to reduce unnecessary API calls and improve performance
* 📝 **Personalized Forms**: Provide academic or professional details to tailor responses
* 🤖 **AI-Generated Answers**: Generates two contextual responses:

  * Why you are applying for financial aid
  * How the course supports your academic or career goals
* 🔁 **Regenerate Responses**: Instantly regenerate alternative responses if needed
* 📋 **One-Click Copy**: Easily copy generated answers to the clipboard
...
A big thank you to **[Ayush](https://github.com/ayush-092005)** for crafting the clean and responsive UI/UX for this project.
...
* 💎 Professional polish that enhances overall usability
